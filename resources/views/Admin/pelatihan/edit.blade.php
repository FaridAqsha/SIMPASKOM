        ...
        <main class="h-full pb-16 overflow-y-auto">
            <div class="container px-6 mx-auto grid">
                <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
                    Form Edit Pengetahuan Pelatihan
                </h2>
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <form id="updateForm" action="{{ route('pelatihan.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div style="display: flex; align-items: center; justify-content: space-between; position: relative; margin-top: 0.5px;">
                                ...
                                <div class="flex justify-end font-semibold mt-3">
                                    <button href="#myModal1"
                                            class="modal-button" style="color: red" data-tippy-content="Tombol Hapus  File Materi" id="panduan">
                                            (-) Hapus File Materi
                                    </button>
                                </div>
                            </div>
...
class="modal fixed inset-0 z-30 flex items-end bg-black bg-opacity-50 sm:items-center sm:justify-center">
    <div
        ...
        <div class="mt-4 mb-6">
            ...
            @foreach($materi as $m)
            <form action="{{ route('pelatihan.materi.delete', $m->id) }}" method="POST">
                @csrf
                @method('DELETE')
                <div style="display: flex; align-items: center; justify-content: space-between; position: relative; margin-top: 0.5px;">
