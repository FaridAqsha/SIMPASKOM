...
<div class="container px-6 mx-auto grid">
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <label class="block mt-4 text-sm">
            <span class="text-gray-700 dark:text-gray-400">Nama Kegiatan Pelatihan</span>
            <input
                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
        ...
        <label class="block mt-4 text-sm">
            <div class="mt-4 text-sm">
                ...
                <div class="mt-2">
                    @foreach($bidang as $b)                    
                    <label class="inline-flex items-center text-sm  focus:outline-none dark:text-gray-300">
        ...
        <label class="block mt-4 text-sm">
            ...
            <div class="relative text-gray-500 focus-within:text-purple-600">
                ...
                <a href="{{ route('pelatihan.materi',['id' => $m->id]) }}">
                   <button type="button" class="absolute inset-y-0 right-0 px-4 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-r-md active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                    Unduh
                   </button>
                </a>
            </div>
        ...
        <label class="block mt-4 text-sm">
            ...
            <div class="relative text-gray-500 focus-within:text-purple-600">
                ...
                <a href="{{ route('pelatihan.sertifikat',['id' => $s->id]) }}">
                    <button
    ...
    <div
        ...
        <div class="mt-4 mb-6">
            ...
            <p class="text-sm text-gray-700 dark:text-gray-400">
                Apakah anda yakin ingin melakukan validasi pada pengetahuan ini?
            </p>
        </div>
        <footer
            ...
            <form action="{{  route('validasi.update', ['id' => $data->id, 'jenis' => $jenis]) }}" method="POST">
                @csrf
                @method('PUT')
                <button
