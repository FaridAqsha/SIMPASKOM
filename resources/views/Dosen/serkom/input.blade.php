...
@section('isi_content')
    ...
    <div class="container px-6 mx-auto grid">
        <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            Form Input Pengetahuan Sertifikasi Kompetensi
        </h2>
        
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <form action="{{ route('serkom.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <label class="block mt-4 text-sm">
                    <div class="flex justify-between">
                                <span class="text-gray-700 dark:text-gray-400" data-tippy-content="Diisi dengan nama kegiatan Sertifikasi Kompetensi" id="panduan">
                                    Nama Kegiatan Sertifikasi Kompetensi
                                </span>
                    ...
                    <input
                        class="block w-full mt-1 text-sm font-bold dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        type="text" name="nama_pengetahuan" placeholder="Nama Pengetahuan Sertifikasi Kompetensi" />
                ...
                <label class="block mt-4 text-sm">
                    ...
                    <input
                        ...
                        @error('penyelenggara')
                            <span class="text-gray-700 dark:text-gray-400 mt-3" style="font-size: small; color:red">Nama penyelenggara harus diisi</span>
                        @enderror
                </label>
                ...
                {{-- <label class="block mt-4 text-sm">
                    <span class="text-gray-700 dark:text-gray-400" >Bidang Kegiatan Sertifikasi Kompetensi Lainnya</span>
                    <input
                        class="block w-full mt-1 text-sm font-bold dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        type="text" name="bidang_lain" placeholder="Bidang Pengetahuan Sertifikasi Kompetensi Lainnya" />
                </label> --}}
                <label class="block mt-4 text-sm">
                    <div class="flex justify-between">
                ...
                <label class="block mt-4 text-sm">
                    ...
                    <textarea
                        ...
                        rows="3"  name="deskripsi" type="text-area" placeholder="Penjelasan Singkat Pengetahuan Sertifikasi Kompetensi"></textarea>
                    @error('deskripsi')
                ...
                <label class="block mt-4 text-sm">
                    ...
                    <input
                        class="block w-full mt-1 text-sm font-bold dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        type="number" name="biaya" placeholder="Biaya Kegiatan Sertifikasi Kompetensi dalam Rupiah (Rp.)" />
                        @error('biaya')
                ...
                <label class="block mt-4 text-sm">
                    ...
                    <button class="text-gray-700 dark:text-gray-400 mt-1" type="button" onclick="addFileInput()" data-tippy-content="Tombol Tambah Upload File Materi" >+ Add More Files</button>
                </label>
...
<div class="mt-4 mb-6">
    ...
    <p class="mb-2 text-lg font-semibold text-gray-700 dark:text-gray-300">
        Konfirmasi Input Pengetahuan Sertifikasi Kompetensi
    </p>
    <!-- Modal description -->
    <p class="text-sm text-gray-700 dark:text-gray-400">
        Apakah anda yakin ingin menginputkan data pengetahuan Sertifikasi Kompetensi ini?
    </p>
</div>
<footer
